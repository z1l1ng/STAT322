...
```{r, include = FALSE}
#Data
shots <- readRDS("~/misc./shotscleaned.rds")

court_sf <- readRDS("~/misc./court_sf.rds")
basic_polys <- readRDS("~/misc./basic_polys.rds")
point_polys <- readRDS("~/misc./point_polys.rds")
distance_polys <- readRDS("~/misc./distance_polys.rds")
angle_polys <- readRDS("~/misc./angle_polys.rds")
shots_sf <- readRDS("~/misc./shots_sf.rds")
```
...
kable(m1_coefficients, format = "latex")
```
\doublespacing
...
A majority of code was used from Oliver Chabot's Spatial Analysis in of Basketball in R (so thank you to him for having this as template to use) 
